...
const translations: Translations = {
  es: {
    ...
    "projects.ch.1": "Diseñé y construí la arquitectura completa: backend en Python, REST APIs, frontend con React + TailwindCSS y base de datos PostgreSQL (Supabase).",
    "projects.ch.2": "Desarrollé bots de scraping 24/7 monitorizando Idealista, Fotocasa, Pisos.com e Indomio en tiempo real.",
    "projects.ch.3": "Desarrollé un sistema de puntuación de propiedades con IA, alertas automatizadas y notificaciones.",
    "projects.ch.4": "Reduje los tiempos de carga un 60% mediante optimización de rendimiento.",
    "projects.ch.5": "Construí un sistema multiusuario con roles, permisos y asignación de exclusividad por zona.",
    ...
    "exp.j1.b1":
      "Diseño, desarrollo y mantenimiento de la plataforma web, reduciendo la velocidad de carga en un 60% (Selenium).",
    "exp.j1.b2":
      "Interfaces de usuario responsivas con React y Tailwind CSS, enfocadas en experiencia de usuario.",
    "exp.j1.b3": "Backend en Python y FastAPI asegurando escalabilidad y mantenimiento eficiente.",
    "exp.j1.b4": "Análisis y reestructuración de bases de datos PostgreSQL con Supabase.",
  ...
  en: {
    ...
    "projects.ch.1": "Designed and built the full architecture: Python backend, REST APIs, React + TailwindCSS frontend and PostgreSQL database (Supabase).",
    "projects.ch.2": "Built 24/7 scraping bots monitoring Idealista, Fotocasa, Pisos.com and Indomio in real time.",
    "projects.ch.3": "Developed an AI-powered property scoring system with automated alerts and notifications.",
    "projects.ch.4": "Reduced page load times by 60% through performance optimization.",
    "projects.ch.5": "Built a multi-user system with roles, permissions and zone-based exclusivity assignment.",
    ...
    "exp.j1.company": "PropTracker",
    "exp.j1.b1": "Designed, built and maintained the platform, cutting load time by 60% (Selenium).",
    "exp.j1.b2": "Responsive UIs with React and Tailwind CSS, focused on user experience.",
    "exp.j1.b3": "Python + FastAPI backend ensuring scalability and efficient maintenance.",
    "exp.j1.b4": "Analysis and restructuring of PostgreSQL databases with Supabase.",
